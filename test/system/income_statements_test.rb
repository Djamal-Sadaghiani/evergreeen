...
class IncomeStatementsTest < ApplicationSystemTestCase
  ...
  test "creating a Income statement" do
    ...
    fill_in "Net income from continuing and discontinued operation", with: @income_statement.net_income_from_continuing_and_discontinued_operation
    fill_in "Net income from continuing operation net minority interest", with: @income_statement.net_income_from_continuing_operation_net_minority_interest
    fill_in "Net interest income", with: @income_statement.net_interest_income
    fill_in "Net non operating interest income expense", with: @income_statement.net_non_operating_interest_income_expense
